...
* Decision:  It was decided that the AWG would initiate a "speaker" series on the topic of "Using CVE Program Automation" where members of the CVE/Vunlerability User community could discuss how they have architected their automation 
